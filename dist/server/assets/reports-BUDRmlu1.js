import { i as formatCurrency, t as buildGrantReport } from "./workspace-D2K6phsh.js";
...
function ReportsOverview() {
	...
	function exportReport() {
		setMessage(`${selectedGrantor} CSV prepared with ${report.totalEnrollments} enrollments and ${formatCurrency(report.dollarsSpent)} in services.`);
	}
