import { a as formatDate, l as getProgram } from "./workspace-D2K6phsh.js";
...
function CasesIndex() {
	...
	const filteredCases = useMemo(() => {
		...
		return scopedCases.filter((caseRecord) => {
			...
			const matchesQuery = !loweredQuery || caseRecord.displayName.toLowerCase().includes(loweredQuery) || String(caseRecord.id).toLowerCase().includes(loweredQuery) || caseRecord.county.toLowerCase().includes(loweredQuery);
	...
	const activeProgram = programId ? getProgram(programs, programId) : void 0;
			...
			children: [/* @__PURE__ */ jsxs(Group, {
				...
				children: /* @__PURE__ */ jsxs(Table, {
					...
					children: [/* @__PURE__ */ jsx(Table.Thead, { children: /* @__PURE__ */ jsxs(Table.Tr, { children: [
						...
						onClick: () => navigate({
							to: "/cases/$caseId",
							params: { caseId: String(caseRecord.id) }
						}),
						role: "link",
						tabIndex: 0,
						onKeyDown: (event) => {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Table.Td, { children: /* @__PURE__ */ jsx(Group, {
								...
								children: caseRecord.enrollments.length > 0 ? caseRecord.enrollments.map((enrollment) => {
									return /* @__PURE__ */ jsx(ProgramBadge, { program: getProgram(programs, enrollment.programId) }, enrollment.id);
								}) : /* @__PURE__ */ jsx(Text, {
									c: "dimmed",
									size: "sm",
									children: "None"
