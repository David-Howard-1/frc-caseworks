import { a as formatDate, c as getPrimaryCaseworker, l as getProgram, o as formatExactCurrency, s as getAssignedCaseworkers, u as getStaff } from "./workspace-DnvJ3Qsu.js";
import { t as useDemoWorkspace } from "./useDemoWorkspace-13E_3_e1.js";
import { t as Route } from "./_caseId-BKJWZGSm.js";
		...
		children: [/* @__PURE__ */ jsxs(Box, {
			...
			children: [/* @__PURE__ */ jsxs(SimpleGrid, {
				...
				children: [
					/* @__PURE__ */ jsx(Select, {
						...
						value: serviceDraft.enrollmentId ? String(serviceDraft.enrollmentId) : null
					}),
					/* @__PURE__ */ jsx(Select, {
						allowDeselect: false,
			...
			children: /* @__PURE__ */ jsxs(Table, {
				...
				children: [/* @__PURE__ */ jsx(Table.Thead, { children: /* @__PURE__ */ jsxs(Table.Tr, { children: [
					...
					/* @__PURE__ */ jsx(Table.Td, { children: /* @__PURE__ */ jsx(ProgramBadge, { program: enrollmentPrograms[service.enrollmentId ?? 0] }) }),
...
function ProgramNotesPortal({ enrollmentPrograms, notes, onAddNote, onEditNote, staff }) {
	return /* @__PURE__ */ jsxs(Stack, {
		gap: "md",
		mt: "md",
		children: [/* @__PURE__ */ jsxs(Group, {
			...
			children: [/* @__PURE__ */ jsxs(Group, {
				...
				children: [/* @__PURE__ */ jsxs(Box, { children: [/* @__PURE__ */ jsxs(Group, {
					gap: "xs",
					children: [
						/* @__PURE__ */ jsx(ProgramBadge, { program: note.enrollmentId ? enrollmentPrograms[note.enrollmentId] : void 0 }),
						/* @__PURE__ */ jsx(Text, {
							fw: 700,
...
function ProgramScopePanel({ caseRecord, enrollmentOptions, enrollmentPrograms, isProgramFiltered, onAddNote, onAddService, onDraftChange, onEditEnrollment, onEditNote, onProgramFilterChange, programId, programs, programNotes, programServices, selectedEnrollment, selectedProgram, serviceDraft, staff }) {
	return /* @__PURE__ */ jsxs(Box, {
...
function ProgramEnrollmentRow({ enrollment, onProgramFilterChange, programs, selected, staff }) {
...
function CaseDetail({ caseId, onProgramFilterChange, programId }) {
	const { addCaseworkerAssignment, addConcreteService, addNote, cases, createEnrollment, editNote, removeCaseworkerAssignment, notes, programs, setPrimaryCaseworker, services, staff, updateCaseStatus, updateEnrollment, visibleCases } = useDemoWorkspace();
	...
	const [enrollmentProgramId, setEnrollmentProgramId] = useState(null);
	...
	const selectedProgram = selectedEnrollment ? getProgram(programs, selectedEnrollment.programId) : void 0;
	const selectedAssignedCaseworkers = selectedEnrollment ? getAssignedCaseworkers(staff, selectedEnrollment) : [];
	...
	const availableEnrollmentPrograms = programs.filter((program) => !caseRecord?.enrollments.some((enrollment) => enrollment.programId === program.id));
	...
	function handleAddCaseworker() {
		...
		addCaseworkerAssignment(currentCase.id, selectedEnrollment.id, Number(caseworkerToAdd));
		setCaseworkerToAdd(null);
	}
	function handleCreateEnrollment() {
		if (!enrollmentProgramId) return;
		const program = programs.find((item) => item.id === Number(enrollmentProgramId));
		createEnrollment({
			caseId: currentCase.id,
			programId: Number(enrollmentProgramId),
			supervisorId: program?.supervisorId,
			status: "Active",
			opened: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10),
			goal: ""
		});
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx(EnrollmentEditorModal, {
			...
			onMakePrimary: (staffId) => selectedEnrollment ? setPrimaryCaseworker(currentCase.id, selectedEnrollment.id, Number(staffId)) : void 0,
			onRemoveCaseworker: (staffId) => selectedEnrollment ? removeCaseworkerAssignment(currentCase.id, selectedEnrollment.id, Number(staffId)) : void 0,
		...
		/* @__PURE__ */ jsxs(Stack, {
			...
			children: [
				...
				availableEnrollmentPrograms.length > 0 ? /* @__PURE__ */ jsx(Box, {
					className: "rounded-md border border-slate-200 bg-white p-4 shadow-sm",
					children: /* @__PURE__ */ jsxs(Group, {
						align: "flex-end",
						justify: "space-between",
						children: [/* @__PURE__ */ jsxs(Box, { children: [/* @__PURE__ */ jsx(Text, {
							fw: 700,
							children: "Add program enrollment"
						}), /* @__PURE__ */ jsx(Text, {
							c: "dimmed",
							size: "sm",
							children: "Attach this case to a program before adding program notes or services."
						})] }), /* @__PURE__ */ jsxs(Group, {
							align: "flex-end",
							children: [/* @__PURE__ */ jsx(Select, {
