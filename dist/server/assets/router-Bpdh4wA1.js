import { n as DemoWorkspaceProvider, t as useDemoWorkspace } from "./useDemoWorkspace-13E_3_e1.js";
import { t as Route$6 } from "./intake-ZT8QVnjW.js";
import { t as Route$7 } from "./new-Cpwg55qw.js";
import { t as Route$8 } from "./_caseId-BKJWZGSm.js";
					...
					children: [/* @__PURE__ */ jsx(Stack, {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Select, {
								...
								label: "Active user",
								onChange: (value) => value ? setCurrentStaffId(Number(value)) : void 0,
...
var $$splitComponentImporter$4 = () => import("./reports-pV8fKaJ3.js");
var Route$4 = createFileRoute("/reports")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
//#endregion
//#region src/routes/intake/route.tsx
var $$splitComponentImporter$3 = () => import("./route-CaXFmBoA.js");
...
var $$splitComponentImporter$1 = () => import("./routes-Ci2c2E8r.js");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
//#endregion
//#region src/routes/cases/index.tsx
var $$splitComponentImporter = () => import("./cases-i01CcWXv.js");
...
var IntakeRouteRoute = Route$3.update({
	id: "/intake",
	path: "/intake",
	getParentRoute: () => Route$5
});
...
var IntakeIndexRoute = Route$6.update({
	id: "/",
	path: "/",
...
var IntakeNewRoute = Route$7.update({
	id: "/new",
	path: "/new",
	getParentRoute: () => IntakeRouteRoute
});
var CasesRouteRouteChildren = {
	CasesCaseIdRoute: Route$8.update({
		id: "/$caseId",
		path: "/$caseId",
		getParentRoute: () => CasesRouteRoute
	}),
...
var CasesRouteRouteWithChildren = CasesRouteRoute._addFileChildren(CasesRouteRouteChildren);
var IntakeRouteRouteChildren = {
	IntakeNewRoute,
	IntakeIndexRoute
};
var rootRouteChildren = {
	...
	IntakeRouteRoute: IntakeRouteRoute._addFileChildren(IntakeRouteRouteChildren),
	ReportsRoute
};
