import { a as formatDate, i as formatCurrency, l as getProgram } from "./workspace-D2K6phsh.js";
				...
				children: [/* @__PURE__ */ jsx(Title, {
					...
					children: /* @__PURE__ */ jsxs(Table, {
						...
						children: [/* @__PURE__ */ jsx(Table.Thead, { children: /* @__PURE__ */ jsxs(Table.Tr, { children: [
							...
							const program = enrollment ? getProgram(programs, enrollment.programId) : void 0;
